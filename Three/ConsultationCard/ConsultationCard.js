...
const VARIANTS = {
  default: {
    ...
    gap: 5,
    speed: 35,
    colors: "#e5e7eb,#d1d5db,#9ca3af", // More subtle grays for white background
    noFocus: false
  },
  blue: {
    activeColor: "#3b82f6",
    gap: 10,
    speed: 25,
    colors: "#93c5fd,#3b82f6,#1d4ed8", // Blue variants
    noFocus: false
  },
  yellow: {
    activeColor: "#f59e0b",
    gap: 3,
    speed: 20,
    colors: "#fcd34d,#f59e0b,#d97706", // Yellow variants
    noFocus: false
  },
  pink: {
    activeColor: "#ec4899",
    gap: 6,
    speed: 80,
    colors: "#f9a8d4,#ec4899,#be185d", // Pink variants
    noFocus: true
  }
};
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <span className="text-2xl font-bold text-gray-800 bg-white/80 px-4 py-2 rounded-lg backdrop-blur-sm">
          {children}
        </span>
      </div>
    </div>
